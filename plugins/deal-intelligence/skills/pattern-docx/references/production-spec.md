# Pattern DOCX Production Spec

Detailed implementation reference for Pattern Word document generation. Read this from `pattern-docx/SKILL.md` before writing or modifying generation code.
