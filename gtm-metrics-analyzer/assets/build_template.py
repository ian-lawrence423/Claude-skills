...
OUT = Path('/mnt/data/gtm_skill_src/gtm-metrics-analyzer/assets/gtm_metrics_template.xlsx')
...
input_rows = [
    ...
    ('Efficiency & Economics','subscription_gross_profit','Subscription Gross Profit','Optional',0),
    ('Efficiency & Economics','subscription_revenue','Subscription Revenue','Optional',0),
    ('Efficiency & Economics','services_gross_profit','Services Gross Profit','Optional',0),
    ('Efficiency & Economics','services_revenue','Services Revenue','Optional',0),
...
metrics = [
    ('Growth Drivers','gross_new_arr','Gross New ARR','Derived','New Logo ARR + Expansion ARR','new_logo_arr, expansion_arr', '=IF(COUNTIF(Input_Fields!$B:$B,"new_logo_arr")*COUNTIF(Input_Fields!$B:$B,"expansion_arr")=0,"",XLOOKUP("new_logo_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,"")+XLOOKUP("expansion_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,""))'),
    ('Growth Drivers','churned_arr','Churned ARR','Derived','Downsell ARR + Logo Churn ARR','downsell_arr, logo_churn_arr', '=IF(COUNTIF(Input_Fields!$B:$B,"downsell_arr")*COUNTIF(Input_Fields!$B:$B,"logo_churn_arr")=0,"",XLOOKUP("downsell_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,"")+XLOOKUP("logo_churn_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,""))'),
    ...
    ('Growth Drivers','ending_arr_calc','Ending ARR (Calculated)','Derived','Beginning ARR + Net New ARR','beginning_arr, new_logo_arr, expansion_arr, downsell_arr, logo_churn_arr', '=IFERROR(XLOOKUP("beginning_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,"")+G4,"")'),
    ...
    ('Growth Drivers','new_logo_mix','% Gross New ARR from New Logo','Derived','New Logo ARR / Gross New ARR','new_logo_arr, expansion_arr', '=IFERROR(XLOOKUP("new_logo_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/G2,"")'),
    ('Growth Drivers','expansion_mix','% Gross New ARR from Expansion','Derived','Expansion ARR / Gross New ARR','new_logo_arr, expansion_arr', '=IFERROR(XLOOKUP("expansion_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/G2,"")'),
    ('Sales Funnel','pipeline_coverage','Pipeline Coverage','Derived','Pipeline $ / Sales Target','pipeline_dollars, sales_target', '=IFERROR(XLOOKUP("pipeline_dollars",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("sales_target",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Sales Funnel','weighted_pipeline_coverage','Weighted Pipeline Coverage','Derived','Weighted Pipeline $ / Sales Target','weighted_pipeline_dollars, sales_target', '=IFERROR(XLOOKUP("weighted_pipeline_dollars",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("sales_target",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Sales Funnel','win_rate','Win Rate','Derived','Closed Won / (Closed Won + Closed Lost)','closed_won_opportunities, closed_lost_opportunities', '=IFERROR(XLOOKUP("closed_won_opportunities",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/(XLOOKUP("closed_won_opportunities",Input_Fields!$B:$B,Input_Fields!$E:$E,"")+XLOOKUP("closed_lost_opportunities",Input_Fields!$B:$B,Input_Fields!$E:$E,"")),"")'),
    ('Sales Funnel','close_rate','Close Rate','Derived','Closed Won in same period / Opportunities created in period','closed_won_same_period, opportunities_created', '=IFERROR(XLOOKUP("closed_won_same_period",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("opportunities_created",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Sales Funnel','sql_to_closed_won','SQL to Closed Won','Derived','Closed Won SQLs / SQL Count','closed_won_sql, sql_count', '=IFERROR(XLOOKUP("closed_won_sql",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("sql_count",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Sales Funnel','forecast_pct_target','Forecast as % of Sales Target','Derived','Forecast $ / Sales Target','forecast_dollars, sales_target', '=IFERROR(XLOOKUP("forecast_dollars",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("sales_target",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Retention','quarterly_ndr','Quarterly Annualized NDR','Derived','1 + ((Quarter Expansion ARR - Quarter Churned ARR) * 4) / avg(BOQ ARR + EOQ ARR)','beginning_arr, ending_arr or calculated ending arr, expansion_arr, downsell_arr, logo_churn_arr', '=IFERROR(1+(((XLOOKUP("expansion_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,"")-(XLOOKUP("downsell_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,"")+XLOOKUP("logo_churn_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,"")))*4)/AVERAGE(XLOOKUP("beginning_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,""),IF(XLOOKUP("ending_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,"")="",G5,XLOOKUP("ending_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,"")))),"")'),
    ('Retention','quarterly_gdr','Quarterly Annualized GDR','Derived','1 - (Quarter Gross Churned ARR * 4) / avg(BOQ ARR + EOQ ARR)','beginning_arr, ending_arr or calculated ending arr, downsell_arr, logo_churn_arr', '=IFERROR(1-((((XLOOKUP("downsell_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,"")+XLOOKUP("logo_churn_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,""))*4)/AVERAGE(XLOOKUP("beginning_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,""),IF(XLOOKUP("ending_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,"")="",G5,XLOOKUP("ending_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,"")))),"")'),
    ('Retention','logo_retention','Logo Retention','Derived','1 - Churned Customers / avg(BOP Customers + EOP Customers)','bop_customers, eop_customers, churned_customers', '=IFERROR(1-(XLOOKUP("churned_customers",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/AVERAGE(XLOOKUP("bop_customers",Input_Fields!$B:$B,Input_Fields!$E:$E,""),XLOOKUP("eop_customers",Input_Fields!$B:$B,Input_Fields!$E:$E,""))),"")'),
    ('Retention','logo_churn','Logo Churn','Derived','Churned Customers / avg(BOP Customers + EOP Customers)','bop_customers, eop_customers, churned_customers', '=IFERROR(XLOOKUP("churned_customers",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/AVERAGE(XLOOKUP("bop_customers",Input_Fields!$B:$B,Input_Fields!$E:$E,""),XLOOKUP("eop_customers",Input_Fields!$B:$B,Input_Fields!$E:$E,"")),"")'),
    ('Retention','dau_rate','DAU Rate','Derived','DAU / Total Users','dau, total_users', '=IFERROR(XLOOKUP("dau",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("total_users",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Retention','mau_rate','MAU Rate','Derived','MAU / Total Users','mau, total_users', '=IFERROR(XLOOKUP("mau",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("total_users",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Retention','adoption_rate','Adoption Rate','Derived','Feature Active Users / Total Users','feature_active_users, total_users', '=IFERROR(XLOOKUP("feature_active_users",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("total_users",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Retention','stickiness_rate','Stickiness Rate','Derived','DAU / MAU','dau, mau', '=IFERROR(XLOOKUP("dau",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("mau",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Retention','time_to_implement_vs_goal','Time to Implement vs Goal','Derived','Actual Implementation Days / Expected Implementation Days','actual_implementation_days, expected_implementation_days', '=IFERROR(XLOOKUP("actual_implementation_days",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("expected_implementation_days",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Retention','nps','NPS','Derived','Promoter % - Detractor %','promoter_pct, detractor_pct', '=IFERROR(XLOOKUP("promoter_pct",Input_Fields!$B:$B,Input_Fields!$E:$E,"")-XLOOKUP("detractor_pct",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Retention','csat','CSAT','Derived','Satisfied Responses / Total Responses','satisfied_responses, total_responses', '=IFERROR(XLOOKUP("satisfied_responses",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("total_responses",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Efficiency & Economics','gross_margin','Gross Margin','Derived','Gross Profit / Total Revenue','gross_profit, total_revenue', '=IFERROR(XLOOKUP("gross_profit",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("total_revenue",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Efficiency & Economics','subscription_gm','Subscription Gross Margin','Derived','Subscription Gross Profit / Subscription Revenue','subscription_gross_profit, subscription_revenue', '=IFERROR(XLOOKUP("subscription_gross_profit",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("subscription_revenue",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Efficiency & Economics','services_gm','Services Gross Margin','Derived','Services Gross Profit / Services Revenue','services_gross_profit, services_revenue', '=IFERROR(XLOOKUP("services_gross_profit",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("services_revenue",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Efficiency & Economics','net_magic_number','Net Magic Number','Derived','Current Quarter Net New ARR / Prior Quarter S&M OpEx','new_logo_arr, expansion_arr, downsell_arr, logo_churn_arr, prior_qtr_sm_opex', '=IFERROR(G4/XLOOKUP("prior_qtr_sm_opex",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Efficiency & Economics','gross_magic_number','Gross Magic Number','Derived','Current Quarter Gross New ARR / Prior Quarter S&M OpEx','new_logo_arr, expansion_arr, prior_qtr_sm_opex', '=IFERROR(G2/XLOOKUP("prior_qtr_sm_opex",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Efficiency & Economics','simple_cac','Simple CAC','Derived','S&M OpEx / Gross New Logo Customers','sm_opex, gross_new_logo_customers', '=IFERROR(XLOOKUP("sm_opex",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("gross_new_logo_customers",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Efficiency & Economics','time_adjusted_cac','Time-Adjusted CAC','Derived','Prior Quarter S&M OpEx / Gross New Logo Customers This Quarter','prior_qtr_sm_opex, gross_new_logo_customers', '=IFERROR(XLOOKUP("prior_qtr_sm_opex",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("gross_new_logo_customers",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Efficiency & Economics','simple_ltv','Simple LTV','Derived','(ARR per Customer * Gross Margin) / Logo Churn Rate','avg_arr_per_customer, gross_margin or gross_margin_pct, logo_churn or provided logo_churn_rate', '=IFERROR((XLOOKUP("avg_arr_per_customer",Input_Fields!$B:$B,Input_Fields!$E:$E,"")*IF(XLOOKUP("gross_margin_pct",Input_Fields!$B:$B,Input_Fields!$E:$E,"")="",G19,XLOOKUP("gross_margin_pct",Input_Fields!$B:$B,Input_Fields!$E:$E,"")))/IF(XLOOKUP("logo_churn_rate",Input_Fields!$B:$B,Input_Fields!$E:$E,"")="",G16,XLOOKUP("logo_churn_rate",Input_Fields!$B:$B,Input_Fields!$E:$E,"")),"")'),
    ('Efficiency & Economics','ltv_cac','LTV / CAC','Derived','Customer LTV / Customer Acquisition Cost','avg_arr_per_customer, margin, churn, sm_opex, gross_new_logo_customers', '=IFERROR(G27/G25,"")'),
    ('Efficiency & Economics','payback_period','Payback Period','Derived','CAC / (ARR per Customer * Gross Margin)','avg_arr_per_customer, margin, sm_opex, gross_new_logo_customers', '=IFERROR(G25/(XLOOKUP("avg_arr_per_customer",Input_Fields!$B:$B,Input_Fields!$E:$E,"")*IF(XLOOKUP("gross_margin_pct",Input_Fields!$B:$B,Input_Fields!$E:$E,"")="",G19,XLOOKUP("gross_margin_pct",Input_Fields!$B:$B,Input_Fields!$E:$E,""))),"")'),
    ('Team & Productivity','sm_opex_per_fte','S&M OpEx per S&M FTE','Derived','(Quarter S&M OpEx * 4) / Average S&M FTEs','sm_opex, avg_sm_ftes', '=IFERROR((XLOOKUP("sm_opex",Input_Fields!$B:$B,Input_Fields!$E:$E,"")*4)/XLOOKUP("avg_sm_ftes",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Team & Productivity','ae_per_csm','AE per CSM','Derived','Quota-Carrying AEs / CSMs','qcr_count, csm_count', '=IFERROR(XLOOKUP("qcr_count",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("csm_count",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Team & Productivity','ae_per_manager','AE per Sales Manager','Derived','Quota-Carrying AEs / Sales Managers','qcr_count, sales_manager_count', '=IFERROR(XLOOKUP("qcr_count",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("sales_manager_count",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Team & Productivity','ae_per_sdr','AE per SDR','Derived','Quota-Carrying AEs / SDRs','qcr_count, sdr_count', '=IFERROR(XLOOKUP("qcr_count",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("sdr_count",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Team & Productivity','employee_attrition','Employee Attrition','Derived','QCRs Departed / Average QCRs in Period','qcr_departed, qcr_count', '=IFERROR(XLOOKUP("qcr_departed",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("qcr_count",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Team & Productivity','nnarr_per_sm_fte','NNARR per S&M FTE','Derived','(Net New ARR * 4) / Average S&M FTEs','new_logo_arr, expansion_arr, downsell_arr, logo_churn_arr, avg_sm_ftes', '=IFERROR((G4*4)/XLOOKUP("avg_sm_ftes",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Team & Productivity','sales_capacity','Sales Capacity','Derived','Allocated Quota * Quota Attainment % * QCR Retention Rate','quota_allocated, quota_attained, qcr_retention_rate', '=IFERROR(XLOOKUP("quota_allocated",Input_Fields!$B:$B,Input_Fields!$E:$E,"")*(XLOOKUP("quota_attained",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("quota_allocated",Input_Fields!$B:$B,Input_Fields!$E:$E,""))*XLOOKUP("qcr_retention_rate",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Team & Productivity','capacity_per_qcr','Capacity per QCR','Derived','Sales Capacity / QCR Count','quota_allocated, quota_attained, qcr_retention_rate, qcr_count', '=IFERROR(G34/XLOOKUP("qcr_count",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Team & Productivity','net_productivity','Net Productivity','Derived','Net New ARR / Average QCRs','new_logo_arr, expansion_arr, downsell_arr, logo_churn_arr, qcr_count', '=IFERROR(G4/XLOOKUP("qcr_count",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Team & Productivity','team_quota_attainment','Team Quota Attainment','Derived','QCRs attaining 100%+ / total QCRs','qcrs_attaining_100, qcr_count', '=IFERROR(XLOOKUP("qcrs_attaining_100",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("qcr_count",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Team & Productivity','rep_attainment','Rep Attainment','Derived','Quota Attained / Quota Allocated','quota_attained, quota_allocated', '=IFERROR(XLOOKUP("quota_attained",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("quota_allocated",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Team & Productivity','ramp_rate','Ramp Rate','Derived','Reps hitting quota in first fully ramped period / reps in first fully ramped period','reps_hit_quota_first_full_ramp, reps_first_full_ramp_period', '=IFERROR(XLOOKUP("reps_hit_quota_first_full_ramp",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("reps_first_full_ramp_period",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Fiscal Maturity','net_new_bookings_attainment','Net New Bookings Attainment','Derived','Actual Net New Bookings / Plan Net New Bookings','net new ARR approximation or actual net bookings, plan_net_new_bookings', '=IFERROR(G4/XLOOKUP("plan_net_new_bookings",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Fiscal Maturity','gross_new_bookings_attainment','Gross New Bookings Attainment','Derived','Actual Gross New Bookings / Plan Gross New Bookings','gross_new_arr, plan_gross_new_bookings', '=IFERROR(G2/XLOOKUP("plan_gross_new_bookings",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Fiscal Maturity','ending_arr_attainment','Ending ARR Attainment','Derived','Actual Ending ARR / Plan Ending ARR','ending arr or calculated ending arr, plan_ending_arr', '=IFERROR(IF(XLOOKUP("ending_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,"")="",G5,XLOOKUP("ending_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,""))/XLOOKUP("plan_ending_arr",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Fiscal Maturity','yoy_arr_growth_attainment','YoY ARR Growth Attainment','Derived','Actual YoY ARR Growth / Plan YoY ARR Growth','actual_yoy_arr_growth_pct, plan_yoy_arr_growth_pct', '=IFERROR(XLOOKUP("actual_yoy_arr_growth_pct",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("plan_yoy_arr_growth_pct",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Fiscal Maturity','fcf_attainment','Free Cash Flow Attainment','Derived','Actual FCF / Plan FCF','actual_fcf, plan_fcf', '=IFERROR(XLOOKUP("actual_fcf",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("plan_fcf",Input_Fields!$B:$B,Input_Fields!$E:$E,""),"")'),
    ('Fiscal Maturity','beat_vs_guidance','Beat Against Revenue Guidance','Derived','(Actual Revenue / Revenue Guidance) - 1','revenue, revenue_guidance', '=IFERROR((XLOOKUP("revenue",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("revenue_guidance",Input_Fields!$B:$B,Input_Fields!$E:$E,""))-1,"")'),
    ('Fiscal Maturity','beat_vs_consensus','Beat Against Revenue Consensus','Derived','(Actual Revenue / Consensus Estimate) - 1','revenue, consensus_estimate', '=IFERROR((XLOOKUP("revenue",Input_Fields!$B:$B,Input_Fields!$E:$E,"")/XLOOKUP("consensus_estimate",Input_Fields!$B:$B,Input_Fields!$E:$E,""))-1,"")'),
]
